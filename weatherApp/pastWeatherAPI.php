...
function display_data($servername, $username, $password, $dbname)
{
    ...
    $all_data = array(); // Initialize the array
...
function connect_DB()
{
    ...
    try {
        ...
        echo $json_data; // Print the weather data by calling the connect_DB function
